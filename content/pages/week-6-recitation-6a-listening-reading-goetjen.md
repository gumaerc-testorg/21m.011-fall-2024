...
In 1716, Vivaldi published a set of concertos which he had composed a few years earlier in 1712–13. Published as {{% resource_link "6b153e28-7b88-469c-bead-cd280d87ccf1" "his Opus 4 and subtitled \"La stravaganza\"" %}} (Extravagance or Eccentricity), this collection features twelve concertos for solo violin.
...
Recording performed by The English Concert, Simon Standage (soloist), directed by Trevor Pinnock. {{% resource_link "52b8bc4d-4dd2-499f-91ec-66d9bed60884" "\[Listen on YouTube\]" %}}
...
These concertos have been quoted and used in a variety of subsequent works throughout the centuries, reinforcing their enduring popularity. As early as 1726 (just a year after the publication of the Four Seasons), J.S. Bach used a theme from the first movement of the Spring concerto (Op. 8 No. 1) in an aria in his cantata, *Wer weiß, wie nahe mir mein Ende?* BWV 27 {{% resource_link "0248dba3-2501-4671-a97f-e7d6ddce558c" "\[Listen on YouTube" %}}). In more recent years, these pieces have been quoted or used in soundtracks for TV and film, as well as samples in pop music recordings. Some brief examples include The Piano Guys 2014 mashup of the Winter concerto with the song “Let It Go” from Frozen {{% resource_link "136aad6f-f5d0-41e7-aeb4-c43c74172e9a" "\[Listen on YouTube\]" %}}, as well as rapper Lupe Fiasco’s 2015 album *Tetsuo & Youth* which samples all four concertos on tracks mixed with samples of sounds associated with those seasons (for instance, the sound of children playing in a pool or maybe at a beach for Summer, {{% resource_link "ee832dc1-9887-4587-908a-c2e6cf318a29" "\[Listen on YouTube\]" %}}. Finally, the Winter concerto is played by the character Wednesday from the 2022 TV show of the same name in a version for solo cello {{% resource_link "2de6989b-ceb1-4fb3-b8f0-605a78d8bab8" "\[Listen on YouTube\]" %}}.
...
The manuscript copy sent to the Margrave is an interesting artifact in its own right. It contains a written dedication message which extols the Margrave’s generosity and good musical taste. While Bach does not directly ask for a job (that would be a major faux pas), it is possible that such a request is the subtext of this dedication. {{% resource_link "9da72d53-670c-4ac7-8f56-0c03e155dba5" "The title page to this manuscript is reproduced in this image" %}}.
...
Recording performed by the Freiburger Barockorchester. {{% resource_link "59bbe1c1-1499-4bfb-9da9-193db13aaf40" "\[Listen on YouTube\]" %}}
